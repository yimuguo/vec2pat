...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scl.setGeometry(QtCore.QRect(460, 30, 51, 20))
        self.scl.setObjectName(_fromUtf8("scl"))
        self.sda = QtGui.QLineEdit(self.general)
        self.sda.setGeometry(QtCore.QRect(460, 70, 51, 20))
        self.sda.setObjectName(_fromUtf8("sda"))
        self.label_7 = QtGui.QLabel(self.general)
        self.label_7.setGeometry(QtCore.QRect(20, 120, 341, 16))
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.label_8 = QtGui.QLabel(self.general)
        self.label_8.setGeometry(QtCore.QRect(20, 190, 341, 16))
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.label_9 = QtGui.QLabel(self.general)
        self.label_9.setGeometry(QtCore.QRect(460, 10, 71, 16))
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.label_10 = QtGui.QLabel(self.general)
        self.label_10.setGeometry(QtCore.QRect(460, 50, 71, 16))
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.label_11 = QtGui.QLabel(self.general)
        self.label_11.setGeometry(QtCore.QRect(380, 10, 61, 16))
        ...
        self.vco_mon = QtGui.QCheckBox(self.vc5_tab)
        self.vco_mon.setGeometry(QtCore.QRect(420, 30, 111, 17))
        self.vco_mon.setChecked(True)
        self.vco_mon.setObjectName(_fromUtf8("vco_mon"))
        ...
        self.del_atp_vc5_2 = QtGui.QCheckBox(self.vc5_tab)
        self.del_atp_vc5_2.setGeometry(QtCore.QRect(380, 220, 131, 16))
        self.del_atp_vc5_2.setChecked(True)
        self.del_atp_vc5_2.setObjectName(_fromUtf8("del_atp_vc5_2"))
        ...
        self.numofpat = QtGui.QComboBox(self.vc3_tab)
        self.numofpat.setGeometry(QtCore.QRect(490, 30, 31, 22))
        ...
        self.del_atp_vc5_3 = QtGui.QCheckBox(self.vc3_tab)
        self.del_atp_vc5_3.setGeometry(QtCore.QRect(380, 220, 131, 16))
        self.del_atp_vc5_3.setChecked(True)
        self.del_atp_vc5_3.setObjectName(_fromUtf8("del_atp_vc5_3"))
        ...
        MainWindow.setTabOrder(self.vc5_btn_file, self.vco_mon)
        MainWindow.setTabOrder(self.vco_mon, self.del_atp)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_9.setText(_translate("MainWindow", "SCL Pinname", None))
        self.label_10.setText(_translate("MainWindow", "SDA Pinname", None))
        self.label_11.setText(_translate("MainWindow", "I2C Address", None))
        ...
        self.vco_mon.setText(_translate("MainWindow", "VCO Monitor OFF", None))
        ...
        self.del_atp_vc5_2.setText(_translate("MainWindow", "Regenerate", None))
        ...
        self.numofpat.setItemText(0, _translate("MainWindow", "3", None))
        self.numofpat.setItemText(1, _translate("MainWindow", "2", None))
        self.numofpat.setItemText(2, _translate("MainWindow", "4", None))
        ...
        self.del_atp_vc5_3.setText(_translate("MainWindow", "Regenerate", None))
